...
package com.huawei.mlkit.alan.landmark;
...
import com.huawei.mlkit.alan.R;
...
public class ImageLandmarkAnalyseActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    //private final int MY_DEMO_IMAGE_ID = R.drawable.landmark_image;
    private final int MY_DEMO_IMAGE_ID = R.drawable.forbidden_city;
    ...
    private void analyzer() {
        ...
        Bitmap bitmap = BitmapFactory.decodeResource(this.getResources(), MY_DEMO_IMAGE_ID); // R.drawable.landmark_image);
